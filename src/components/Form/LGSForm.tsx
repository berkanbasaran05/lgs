...
const LGSForm = () => {
  const campuses = [
    { value: 1, text: "Atakent" },
    { value: 2, text: "Bahçeşehir" },
    { value: 3, text: "Büyükçekmece" },
...
onSubmit: async (values, { resetForm }) => {
  const formattedValues = {
    ...values,
    turkishCorrectAnswer: Number(values.turkishCorrectAnswer),
    turkishWrongAnswer: Number(values.turkishWrongAnswer),
    historyCorrectAnswer: Number(values.historyCorrectAnswer),
    historyWrongAnswer: Number(values.historyWrongAnswer),
    religionCorrectAnswer: Number(values.religionCorrectAnswer),
    religionWrongAnswer: Number(values.religionWrongAnswer),
    foreignLanguageCorrectAnswer: Number(values.foreignLanguageCorrectAnswer),
    foreignLanguageWrongAnswer: Number(values.foreignLanguageWrongAnswer),
    mathPointCorrectAnswer: Number(values.mathPointCorrectAnswer),
    mathPointWrongAnswer: Number(values.mathPointWrongAnswer),
    sciencePointCorrectAnswer: Number(values.sciencePointCorrectAnswer),
    sciencePointWrongAnswer: Number(values.sciencePointWrongAnswer),
  };

  try {
    setLoading(true); 
    await axiosInstance.post(`/contact/createLgsForm`, formattedValues);
  ...
  return (
    <form className="flex flex-col  items-center space-y-4 mt-4 w-full" onSubmit={handleSubmit}>
      ...
      <div className='flex flex-row space-x-4 items-center justify-between text-xs p-4 w-full shadow-md rounded-2xl'>
        ...
        <span className="text-[10px] md:text-[12px]" style={{ whiteSpace: "nowrap" }}>
      ...
      <div className='flex flex-row space-x-4 items-center justify-between text-xs p-4 w-full shadow-md rounded-2xl'>
        ...
        <span className="text-[10px] md:text-[12px] font-normal" style={{ whiteSpace: "nowrap" }}>
      ...
      <div className='flex flex-row space-x-4 items-center justify-between text-xs p-4 w-full shadow-md rounded-2xl'>
        ...
        <span className="text-[10px] md:text-[12px]" style={{ whiteSpace: "nowrap" }}>
          Net Doğru: {isNaN(values.foreignLanguageCorrectAnswer) || isNaN(values.foreignLanguageWrongAnswer)
            ? 0
            : Math.max(-10, values.foreignLanguageCorrectAnswer - values.foreignLanguageWrongAnswer / 3).toFixed(2)}
        </span>
      </div>
      <div className="mt-12">
      ...
      {open && (
        <>
          ...
          <div className="flex flex-row space-x-4 items-center justify-between text-xs p-4 w-full shadow-md rounded-2xl">
            <div className="w-[200px] md:w-[300px]">
              <Link href={'/'} className='text-[12px] font-thin'>
