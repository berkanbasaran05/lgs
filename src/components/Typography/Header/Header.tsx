...
const Header: FC<HeaderProps> = ({ children, variant, className }) => {
  ...
  if (variant === "h4") {
    return (
      <h4
        className={`text-lg font-semibold md:text-xl text-brand-black-primary ${
          className || ""
        }`}
      >
        {children}
  ...
  if (variant === "h5") {
    return (
      <h5
        className={`text-base font-semibold md:text-lg text-brand-black-primary ${
          className || ""
        }`}
      >
        {children}
  ...
  if (variant === "h7") {
    return (
      <h2
        className={`text-[24px] font-semibold md:text-3xl text-brand-black-primary ${
          className || ""
        }`}
      >
        {children}
